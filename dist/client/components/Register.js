...
class Register extends Component {
    onButtonPress() {
        ...
        this.props.userCreate({ name, email, password });
    }
    renderButton() {
        if (this.props.loading) {
            return React.createElement(Spinner, null);
        }
        return (React.createElement(Button, { bgColor: "#000000", onPress: this.onButtonPress.bind(this) }, "Register"));
    }
    render() {
        return (React.createElement(LoginWallpaper, null,
            ...
            React.createElement(CardSection, null,
                React.createElement(Input, { placeholder: "name", value: this.props.name, onChangeText: value => this.props.userUpdate({ prop: "name", value }) })),
            React.createElement(CardSection, null,
                React.createElement(Input, { placeholder: "email", value: this.props.email, onChangeText: value => this.props.userUpdate({ prop: "email", value }) })),
            React.createElement(CardSection, null,
                React.createElement(Input, { secureTextEntry: true, placeholder: "Password", value: this.props.password, onChangeText: value => this.props.userUpdate({ prop: "password", value }) })),
