...
import { loginUpdate, forgetPassword } from "../actions";
...
class Forget extends Component {
    ...
    renderButton() {
        ...
        return (React.createElement(Button, { bgColor: "#000000", onPress: this.onButtonPress.bind(this) }, "Reset Password"));
    }
    render() {
        return (React.createElement(LoginWallpaper, null,
            ...
            React.createElement(CardSection, null,
                React.createElement(Input, { placeholder: "Email", value: this.props.email, onChangeText: value => this.props.loginUpdate({ prop: "email", value }) })),
            React.createElement(CardSection, null,
...
export default connect(mapStateToProps, { loginUpdate, forgetPassword })(Forget);
const styles = {
    loginLable: {
        fontSize: 12,
        margin: 10,
